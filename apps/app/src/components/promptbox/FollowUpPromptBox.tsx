    ...
    >
      ...
      {!isPromptBoxCompact ? (
        <div
          ...
          className="mt-1 flex min-h-6 max-h-6 min-w-0 select-none items-center justify-between gap-2 overflow-hidden pl-4 pr-3.5 opacity-100 transition-[max-height,min-height,margin-top,opacity] duration-[180ms] ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none"
        >
