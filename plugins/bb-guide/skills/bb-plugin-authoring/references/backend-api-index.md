...
- `experimental_aiVoiceCapabilitiesInputSchema`
- `experimental_aiVoiceCapabilitiesOutputSchema`
- `experimental_aiVoiceModelDownloadInputSchema`
- `experimental_aiVoiceModelMutationOutputSchema`
- `experimental_aiVoicePrepareOutputSchema`
- `experimental_aiVoiceProfileCreateInputSchema`
- `experimental_aiVoiceProfileDeleteInputSchema`
- `experimental_aiVoiceProfileMutationOutputSchema`
- `experimental_aiVoiceProfileSampleAddInputSchema`
- `experimental_aiVoiceProfileSampleOutputSchema`
- `experimental_aiVoiceProfileSampleRemoveInputSchema`
- `experimental_aiVoiceProfileUpdateInputSchema`
- `experimental_aiVoiceProfilesInputSchema`
- `experimental_aiVoiceProfilesOutputSchema`
- `experimental_aiVoiceReleaseOutputSchema`
- `experimental_aiVoiceRepairInputSchema`
- `experimental_aiVoiceRepairOutputSchema`
- `experimental_aiVoiceSpeakInputSchema`
- `experimental_aiVoiceSpeakOutputSchema`
- `experimental_aiVoiceStatusInputSchema`
- `experimental_aiVoiceStatusOutputSchema`
- `experimental_aiVoiceTranscribeInputSchema`
- `experimental_aiVoiceTranscribeOutputSchema`
- `experimental_voiceEngineCapabilitiesSchema`
- `experimental_voiceModelStateSchema`
- `experimental_voiceProfileSchema`
